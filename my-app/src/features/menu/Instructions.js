...
export const Instructions = () => (
  <div className={styles.instructions}>
    ...
    <br /> You don’t lose points when you click on a wrong card.
    <h3>Time</h3> Each round starts with 30 seconds on the clock. <br /> When
    ...
    wrong cards! <br /> When you run out of time, the game is over.
    <h3>Bonus</h3>
    Each level has a bonus timer. If you find the correct card within 3 seconds,
    you get 3 points instead of 1! <h3>End of the game</h3> Game ends when you
