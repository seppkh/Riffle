...
export const Instructions = () => (
  <div className={styles.instructions}>
    ...
    smaller cards on the bottom. Your goal is to find the correct card from
    three bottom cards. How exactly? Each card has a number of elements. On the
    ...
    those matching elements. Keep playing and the number of matching elements
    ...
    playing. Total number of elements on cards may vary. When you click on the
    correct card, you go level up. When you click on a wrong card, you lose a
    life, but can keep guessing. <h3>Lives</h3> You have 3 lives in total. When
    you lose all lives, the game is over. Score Each correct card gives you 1
